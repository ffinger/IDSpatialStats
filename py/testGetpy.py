...
class SimpleTests(unittest.TestCase):
	...
	def testOne(self):
		print "test that get.pi returns appropriate values for cannonical test case 1 (equilateral triangle)"
	...
	def testTwo(self):
		print "test that get.pi returns appropriate values cannonical test case 2 (points on a line)"
